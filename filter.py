...
# The filter is built base on human experience
    ...
    for sample in samples:
        try:
            ...
            if yesterdayindex > -1 and yesterdayindex > 20 and todayindex > 20 and todayindex < len(sample.dates):
                ...
                if lastClose_bUp=="BelowZero" and lastClose_bMd=="BelowZero" and lastOpen_bUp=="AboveZero" \
                        and lastOpen_bMd=="AboveZero" and thisChange=="AboveZero" and thisClose_bUp=="AboveZero" \
                        and thisV_b=="BelowZero" and ifHengPan==True:
                    result.append(sample)
                    continue
                if lastClose_bUp=="AboveZero" and lastOpen_bUp=="AboveZero" and thisChange=="AboveZero" \
                        and thisClose_bUp=="BelowZero" and thisV_b=="AboveZero" and ifHengPan==True:
                    result.append(sample)
                    continue
        except Exception as e:
    ...
    for sample in samples:
        try:
            ...
            if yesterdayindex > -1 and yesterdayindex > 20 and todayindex > 20 and todayindex < len(sample.dates):
                ...
                thisV_b = floatFormat(sample.v_b(sample.v_ma5[todayindex], sample.volume[todayindex]))
                ifHengPan = sample.checkIfHengPan(conditionday)
                if thisOpen_bUp=="BelowZero" and lastOpen_bUp=="BelowZero" and lastClose_bMd=="AboveZero" \
                        and lastOpen_bMd=="BelowZero" and thisClose_bUp=="AboveZero" \
                        and ifHengPan==True and lastClose_bUp=="AboveZero" and thisV_b=="AboveZero":
                    result.append(sample)
                    continue
                if thisOpen_bUp=="BelowZero" and lastOpen_bUp=="AboveZero" and thisChange=="BelowZero" \
                        and lastClose_bMd=="AboveZero" and thisV_b=="AboveZero" and ifHengPan==True \
                        and lastClose_bUp=="BelowZero":
                    result.append(sample)
                    continue
                if thisOpen_bUp=="BelowZero" and lastOpen_bUp=="AboveZero" and thisChange=="AboveZero" \
                        and thisClose_bUp=="BelowZero" and lastClose_bUp=="AboveZero" \
                        and thisV_b=="AboveZero" and ifHengPan==True:
                    result.append(sample)
                    continue
                if thisOpen_bUp=="BelowZero" and lastOpen_bUp=="AboveZero" and thisChange=="AboveZero" \
                        and thisClose_bUp=="AboveZero" and thisV_b=="BelowZero" and ifHengPan==True \
                        and lastClose_bMd=="BelowZero":
                    result.append(sample)
                    continue
                if thisOpen_bUp=="AboveZero" and thisV_b=="AboveZero" and ifHengPan==True and thisChange=="BelowZero" \
                        and lastClose_bUp=="BelowZero" and lastOpen_bUp=="BelowZero" \
                        and lastClose_bMd=="AboveZero" and lastOpen_bMd=="BelowZero" and thisClose_bUp=="BelowZero":
                    result.append(sample)
                    continue
                if thisOpen_bUp=="AboveZero" and thisV_b=="AboveZero" and ifHengPan==True and thisChange=="BelowZero" \
                        and lastClose_bUp=="BelowZero" and lastOpen_bUp=="AboveZero":
                    result.append(sample)
        except Exception as e:
